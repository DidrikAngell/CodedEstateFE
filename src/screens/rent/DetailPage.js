...
export function RentDetailPage() {
  ...
  const [connected, setConnected, updateConnected] =
    store.useState("Connected");
  const [walletModalShow, setWalletModalShow, updateWalletModalShow] =
    store.useState("WalletModalShow");
  ...
  return (
    <div className="DetailPage my-4 container" style={{ marginTop: "81px" }}>
      <NavLink to="/rent" className="nav-link text-purple fw-bold fs-6 my-2">
      ...
      <div
        className="NFTGallary my-3 border-bottom pb-3 overflow-hidden"
        style={{ height: "500px" }}
        onClick={() => {
          setVisible(true);
        }}
      >
        <div className="d-flex align-items-center justify-content-between gap-2 rounded overflow-hidden">
          <div
            ...
            style={{ height: "500px", minHeight: 500 }}
          >
            <Image
              src={state?.images[0]}
              width="100%"
          ...
          >
            <div className="d-flex align-items-center justify-content-between gap-2 mb-2">
              <div className="w-50 overflow-hidden" style={{ height: "250px" }}>
                <Image
                  src={state?.images[1]}
                  width="100%"
                  height="100%"
      ...
      <Row>
        <Col sm={12} md={8}>
          <div className="d-flex align-items-center justify-content-between my-2 border-bottom pb-2">
            <div className="">
              <div className="text-dark-purple fs-5 fw-semibold">
                Entire villa Hosted by sei14zd...0qzk
              </div>
              <div className="text-gray mt-2">
                <small className="text-gray">
                  5 guests • 3 bedrooms • {state?.bed} beds • {state?.bath}{" "}
                  baths
                </small>
              </div>
            </div>
          ...
          <div className="my-2 border-bottom pb-2">
            <div className="d-flex my-3">
              ...
              <div className="">
                <div className="text-dark-purple fw-bold fs-5">
                  Dive right in
                </div>
                <small className="text-gray">
                  This is one of the few place in the area with a pool.
                </small>
              </div>
            </div>
            <div className="d-flex my-3">
              ...
              <div className="">
                ...
                <small className="text-gray">
                  Bookiply has 1429 reviews for other places
                </small>
              </div>
            </div>
            <div className="d-flex my-3">
              ...
              <div className="">
                ...
                <small className="text-gray">
                  Bookily has recieved 5-star ratings from 100% of recent
                  guests.
                </small>
              </div>
            </div>
          ...
          <div className="my-2 border-bottom pb-2">
            <p className="text-gray">
              ...
              location and the unique panoramic views of the surrounding
              mountain panorama and the Merano valley basin. The large window
              areas, the elegant sun terraces with glass balustrade and the
              modern Desgin make the mansion Goyen an exclusive vacation
              domicile, which fulfills highest requirements at cosiness, comfort
              and situation. 200m² living space, 400m² garden, sun terrace and
              roof terrace with floating bed. 3 suites all with terrace.
            </p>
          </div>
          <div className="my-2 border-bottom pb-2">
            <div className="text-dark-purple fs-5 fw-semibold mb-3">
        ...
        <Col sm={12} md={4}>
          <Card className="shadow rentCard">
            <Card.Body>
              <div className="fs-6 fw-semibold mb-3">
                <span className="me-1">
                  <Image src={SEI} width="18" className="mx-1" />
                  357
                </span>
                <small className="text-gray">night</small>
              </div>
              ...
              {!connected ? (
                <Button
                  className="text-white bg-dark-purple border-dark-purple fs-5 fw-bold w-100 my-2"
                  onClick={walletConnectModalShow}
                >
                  Reserve
                </Button>
              ) : (
              ...
              <div className="d-flex align-items-center justify-content-between my-2">
                <small className="text-gray">357 SEI X 27 night</small>
                <small className="text-gray">9,650 SEI</small>
              </div>
              <div className="d-flex align-items-center justify-content-between my-2">
                <small className="text-gray">Cleaning fee</small>
                <small className="text-gray">131 SEI</small>
              </div>
              <div className="d-flex align-items-center justify-content-between my-2">
                <small className="text-gray">Service fee</small>
                <small className="text-gray">0 SEI</small>
              </div>
              <hr />
              <div className="d-flex align-items-center justify-content-between my-2">
      ...
      <Row className="my-2 border-bottom py-2">
        ...
        <div className="d-flex align-items-center my-2">
          ...
          <div className="text-gray">
            This host has 1,429 reviews for other places to stay. Show other
            reviews
          </div>
        </div>
      </Row>
        ...
        <Row className="my-2 border-bottom pb-3 pt-3">
          ...
          <Col sm={12} md={6} className="my-2">
            ...
            <div className="text-gray mt-3">
              DE
              <br />
              Mit Bookiply finden Sie ganz einfach Ihre perfekte
              Ferienunterkunft. Eine schöne Villa mit Meerblick auf Sardinien?
              Ein gemütliches Apartment am Gardasee oder ein Chalet in…
              <span className="ms-2 text-dark-purple">
                <u>read more</u>
              </span>
            </div>
          </Col>
          <Col sm={12} md={6}>
            ...
            {!connected ? (
              <Button
                className="border-gray bg-white text-dark-purple"
                onClick={walletConnectModalShow}
              >
                Contact host
              </Button>
      ...
      <Modal show={messageModal} size="sm" centered>
        <Modal.Body>
          <div className="text-end">
            <AiOutlineClose onClick={hideMessageModal} />
          </div>
          ...
          <div className="d-flex align-items-center justify-content-around">
            <Button
              className="border-dark-purple bg-white text-dark-purple fw-bold fs-6 px-4"
              onClick={hideMessageModal}
            >
              Cancel
            </Button>
            <NavLink to="/dashboard/rent/message">
              <Button className="border-dark-purple bg-dark-purple text-white fw-bold fs-6 px-4">
                Send
              </Button>
            </NavLink>
          </div>
